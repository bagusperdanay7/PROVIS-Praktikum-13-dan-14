 ...
 */
public class FTambahMahasiswa extends JDialog {
    public JLabel lnim,lnama,ljk,ltinggi;
    public JTextField tnim,tnama,tjk,ttinggi;
    public JButton tblsimpan,tblbatal;
    private Database db;
    public FTambahMahasiswa(JFrame parent){
        super(parent,"Tambah Mahasiswa",true);// true = dialog modal
        setSize(350,250);
        setLayout(null);
